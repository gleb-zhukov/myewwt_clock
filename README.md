# Функции данного устройства выполняет реле или розетка, настроенные в режим шлюза. Подробная и актуальная информация [здесь](https://github.com/zhukov-technologies/zhukov_socket_and_relay).
